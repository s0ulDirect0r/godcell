...
export { World, ComponentStore, Components, Tags, getRandomSpherePosition } from '#shared';
export type {
  EntityId,
  ComponentType,
...
export {
  ...
  // ECS Setters - update component values directly (legacy, prefer entity-based)
  setEnergyBySocketId,
  ...
  setInputBySocketId,
  // Entity-based component access (game layer helpers)
  getEnergy,
  getPosition,
  getStage,
  getVelocity,
  ...
  getDamageTracking,
  isBot,
  // Throwing component access (invariant enforcement)
  requireEnergy,
  requirePosition,
  requireStage,
  requireVelocity,
